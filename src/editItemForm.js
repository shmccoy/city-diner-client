...
export default class EditItemForm extends Component {
  ...
  return (
    <form onSubmit={this.handleSubmit}
      >
      <label>Name</label><br />
      <input type="text" name="name" value={this.state.name} onChange={ (e) => this.handleNameChange(e)} /><br />
      <label>Description</label><br />
      <textarea rows="4" cols="50" name="description" value={this.state.description} onChange={ (e) => this.handleDescriptionChange(e)} /><br />
      <label>Price</label><br />
      <input type="text" name="price" value={this.state.price} onChange={ (e) => this.handlePriceChange(e)} /><br />
      <label>Category</label><br />
      <select id="category" name="category" value={this.state.category} onChange={ (e) => this.handleCategoryChange(e)}>
